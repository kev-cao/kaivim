...
local M = {
  { import = "kaivim.plugins.lang.cmp" },
  { import = "kaivim.plugins.lang.lint" },
  { import = "kaivim.plugins.lang.lsp.lsp" },
  { import = "kaivim.plugins.lang.parser" },
  { import = "kaivim.plugins.lang.format" }
}
